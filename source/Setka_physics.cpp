...
void Setka::Init_physics(void)
{
	...
	if (false)
	{
		for (auto& i : this->All_Cell)
		{
			...
			i->parameters[0]["Vx_H3"] = (i->parameters[0]["rho_H3"] * i->parameters[0]["Vx_H3"] + i->parameters[0]["rho_H4"] * i->parameters[0]["Vx_H4"]) /
				(i->parameters[0]["rho_H3"] + i->parameters[0]["rho_H4"]);
			i->parameters[0]["Vy_H3"] = (i->parameters[0]["rho_H3"] * i->parameters[0]["Vy_H3"] + i->parameters[0]["rho_H4"] * i->parameters[0]["Vy_H4"]) /
				(i->parameters[0]["rho_H3"] + i->parameters[0]["rho_H4"]);
			i->parameters[0]["Vz_H3"] = (i->parameters[0]["rho_H3"] * i->parameters[0]["Vz_H3"] + i->parameters[0]["rho_H4"] * i->parameters[0]["Vz_H4"]) /
				(i->parameters[0]["rho_H3"] + i->parameters[0]["rho_H4"]);
			i->parameters[0]["rho_H3"] = i->parameters[0]["rho_H3"] + i->parameters[0]["rho_H4"];
			i->parameters[0]["p_H3"] = i->parameters[0]["p_H4"] + i->parameters[0]["p_H4"];

			i->parameters[0]["rho_H4"] = 0.00000001;
	...
	if (true)
	{
		for (auto& i : this->All_boundary_Gran)
		{
			if (i->type == Type_Gran::Outer_Hard)
			{
				...
				i->parameters["rho_H3"] = 1.0;
				i->parameters["Vx_H3"] = this->phys_param->Velosity_inf;
				i->parameters["Vy_H3"] = 0.0;
				i->parameters["Vz_H3"] = 0.0;
				i->parameters["p_H3"] = 0.5;
